...
class Pad extends Component {
  ...
  render = () => {
    ...
    return (
      <div>
        <div className="box" style={{ transform: "translate(9px, 9px)", background: this.state.color }}></div>
        <div className="box" style={{ transform: "translate(6px, 6px)", background: this.state.color }}></div>
        <div className="box" style={{ transform: "translate(3px, 3px)", background: this.state.color }}></div>
        <div className="box" style={{background: this.state.color}}>
          <form onSubmit={this.onFormSubmit} className="new-form">
            ...
            <img src="colorpal.svg" alt="select color" onClick={this.handleColorClick}/>
            {this.state.displayColorPicker && (
              <div className="popover">
                  ...
                  />
                <div className="cover" onClick={this.handleCloseColorPicker} style={{zIndex: -1}}>
                </div>
              </div>
            )}
          </form>
